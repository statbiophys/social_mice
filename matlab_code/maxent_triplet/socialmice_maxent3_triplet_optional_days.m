function socialmice_maxent3_triplet_optional_days...
    (di, df, ttscheme_number)
% Learn triplet maximum entropy models with training / test split, and
% with various strength of L2 regularization on the triplet interactions,
...
switch ttscheme
    case '1h'
        ...
        gijkFinal3 = zeros(nNodes*(nNodes-1)*(nNodes-2)/6, 6, length(beta_G2));
        ...
        for itest = 1:6
            ...
            for ibeta = 1:length(beta_G2)
                ...
                tripletStruct.beta_G = beta_G;

                [jijFinal, hirFinal, gijkFinal] = ...
                ...
                gijkFinal3(:, itest, ibeta) = gijkFinal;
            end
        end
...
save(fp,'jijFinal3','hirFinal3','gijkFinal3');
